...
const db = mysql.createConnection({
  host: 'sannmedata_base',     // Docker routes this name to the database!
  user: 'server_name',         // The user set in docker-compose
  password: 'someweakpassword', // The password set in docker-compose
  database: 'hehe' // The database name set in docker-compose
});
...
// Start server
app.listen(PORT, () => {
  console.log(`🚀 Server running on somethingsomething:${PORT}`);
  console.log(`📡 API available at somethingsomething:${PORT}/api/products`);
});
